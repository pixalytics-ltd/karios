...
class LargeOffsetMatcher:
    ...
    def match(self):
        ...
        return phase_cross_correlation(self._mon.array, self._ref.array,reference_mask=~np.isnan(self._mon.array), moving_mask=~np.isnan(self._ref.array))#[0]  # , reference_mask=reference_mask, moving_mask=moving_mask)
